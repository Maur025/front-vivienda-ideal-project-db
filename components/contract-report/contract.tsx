	...
	return (
		<TabsContent value="contratos" className="space-y-6">
			<div className="flex justify-between items-center">
				<h2 className="text-xl font-semibold text-gray-100">Gestión de Contratos</h2>
				<Dialog>
			...
			<Card className="bg-gray-900 border-gray-800">
				<CardHeader>
					<CardTitle className="text-gray-100">Contratos</CardTitle>
					<CardDescription className="text-gray-400">Lista de contratos.</CardDescription>
				</CardHeader>
				<CardContent>
					<Table>
						<TableHeader>
