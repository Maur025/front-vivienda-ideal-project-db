...
const PendingPayment = (): JSX.Element => {
	...
	return (
		<TabsContent value="pagosPendientes" className="space-y-6">
			<div className="flex justify-between items-center">
				<h2 className="text-xl font-semibold text-gray-100">Gestión de Pagos Pendientes</h2>
				<Dialog>
			...
			<Card className="bg-gray-900 border-gray-800">
				<CardHeader>
					<CardTitle className="text-gray-100">Pagos Pendientes</CardTitle>
					<CardDescription className="text-gray-400">
						Lista de los pagos pendientes.
					</CardDescription>
				</CardHeader>
				<CardContent>
					<Table>
